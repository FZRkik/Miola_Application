        ...
        registerBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(pw)){
                    Rpasswd.setError("Donnez un mot de passe au Professeur !");
                    return ;
                }

                if (TextUtils.isEmpty(fn)){
                    RfullName.setError("Entrez le nom complet du Professeur !");
                    return ;
                }
                ...
                if (TextUtils.isEmpty(cne)){
                    Rcne.setError("Entrez le departement du Professeur!");
                    return ;
                }
                ...
                if (TextUtils.isEmpty(dn)){
                    ...
                    loader.setMessage("Ajout du professeur ...");
                    ...
                    mAuth.createUserWithEmailAndPassword(email,pw).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(!task.isSuccessful()){
                                ...
                                Toast.makeText(ProfRegisterActivity.this,error,Toast.LENGTH_SHORT).show();
                            }
                            else{
                                ...
                                userInfo.put("type","Prof");

                                userDataBaseRef.updateChildren(userInfo).addOnCompleteListener(new OnCompleteListener() {
                                    @Override
                                    public void onComplete(@NonNull Task task) {
                                        if(task.isSuccessful()){
                                            Toast.makeText(ProfRegisterActivity.this,"Professeur est ajouté avec succes",Toast.LENGTH_SHORT).show();
                                        }
                                        else {
                                            Toast.makeText(ProfRegisterActivity.this,task.getException().toString(),Toast.LENGTH_SHORT).show();
                                        }
                                        finish();
                                    }
                                });

                                Intent intent=new Intent(ProfRegisterActivity.this , AdminMain.class);
